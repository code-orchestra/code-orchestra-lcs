 ...
 *     Code Orchestra Limited - added image support
 *******************************************************************************/
...
public class StatusLineContributionItemEx extends ContributionItem {
  ...
  /**
   * A constant indicating that the contribution should compute its actual size
   * depending on the text. It will grab all space necessary to display the
   * whole text.
   * 
   * @since 3.6
   */
  ...
  /**
   * The composite into which this contribution item has been placed. This will
   * be <code>null</code> if this instance has not yet been initialized.
   */
   ...
   */
  public StatusLineContributionItemEx(String id, int charWidth) {
    super(id);
