...
public class FlexConfig {
  ...
  public File saveToFile(String filename) throws LCSException {
  ...
  public Document toXML() throws LCSException {
    Document document = XMLUtils.createDocument();
    if (document == null) {
      throw new LCSException("Can't create config XML document");
    }
