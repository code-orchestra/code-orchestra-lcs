...
public class ScreenHelper {
  ...
  public static int getScreenID(IRelocableComponent c) {
    int scrID = 1;
    ...
    for (int i = 0; i < gd.length; i++) {
      ...
      Point locPoint = new Point(c.getLocationX(),c.getLocationY());
      if (r.contains(locPoint)) {
        scrID = i + 1;
      }
    }
    return scrID;
  ...
  public static void centerOnScreen(final IRelocableComponent c, final boolean absolute) {
